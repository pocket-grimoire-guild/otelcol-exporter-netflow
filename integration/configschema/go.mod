module github.com/pocket-grimoire-guild/otelcol-exporter-netflow/integration/configschema

go 1.26.0

require (
	github.com/google/jsonschema-go v0.4.3
	github.com/pocket-grimoire-guild/otelcol-exporter-netflow v0.0.0
...
replace github.com/pocket-grimoire-guild/otelcol-exporter-netflow => ../..
